...
CREATE TABLE `consentimientopaciente` (
  `idConcentimientoPaciente` int NOT NULL,
...
CREATE TABLE `historialedodoncia` (
  `idHistorialEdodoncia` int NOT NULL,
...
CREATE TABLE `historialodontologiageneral` (
  `idHistorialOdontologiaGeneral` int NOT NULL,
...
CREATE TABLE `historialodontopediatria` (
  `idHistorialOdontopediatria` int NOT NULL,
...
CREATE TABLE `historialrehabilitacionoral` (
  `idHistorialRehabilitacionOral` int NOT NULL,
...
CREATE TABLE `registroevolucion` (
  `idRegistroEvolucion` int NOT NULL,
