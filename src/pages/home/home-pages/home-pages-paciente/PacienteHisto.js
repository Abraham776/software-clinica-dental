				...
				<Form inline>
					<FormGroup row>
						<Col sm={4}>
							...
							<Input type="text" name="nombre" id="nombreField" disabled />
						...
						<Col sm={4}>
							...
							<Input type="text" name="lugar-nacimiento" id="lugar-nacimientoField" disabled/>	
						...
						<Col sm={4}>
							...
							<Input type="date" name="fecha-nacimiento" id="fecha-nacimientoField" disabled/>
