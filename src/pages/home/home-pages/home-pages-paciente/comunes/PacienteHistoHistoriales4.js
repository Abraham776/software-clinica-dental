	...
	return (
		<div className="home-contenido">
			...
			<div className="contenido-in-historiales">
				{/* Inputs */}
				<Form inline>
					<center><h1>Historial Clinico de Endodoncias</h1></center>

					<table class="paciente-historiales">
						<tr>
							<td><img src={LogoLogin} alt="logo" />	</td>
							<td><h2>Paciente:</h2>
								<Button onClick={function(){window.location.href=`/NuevoHistorialEndo/${id}`}}>Agregar nueva historia clinica</Button></td>
						</tr>
					</table>
					<center><table class="default">
						...
						<tr>
							...
							<th><Button onClick={function(){window.location.href=`/NuevoHistorialEndo/${id}`}}>Ver</Button></th>
						</tr>
					</table></center>
